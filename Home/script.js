window.onload = function() {
    ...
    document.getElementById('link2').addEventListener('click', function(e) {
      ...
      document.getElementById('massageTerminology').addEventListener('click', function(e) {
        e.preventDefault();
        loadMainContent('<iframe src="https://docs.google.com/document/d/e/2PACX-1vTNb6pRrRXlvhiBAbX-acrtwu3XSEhy75RH0ygnJobS29fKu84E-szQuaR0SL5bPlZxJATGUwQZrh6f/pub?embedded=true" frameborder="0" width="100%" height="600px"></iframe>');
      });
  
      document.getElementById('fiveStrokes').addEventListener('click', function(e) {
        e.preventDefault();
        loadMainContent('<iframe src="https://docs.google.com/document/d/e/2PACX-1vT1kdsm6jVbwfhaWY1Verf1gyqYHOqH9UgrJFdf1FU_CldFnnDWR0YBJCGsFhHz-w/pub?embedded=true" frameborder="0" width="100%" height="600px"></iframe>');
      });
  
      document.getElementById('endangermentSites').addEventListener('click', function(e) {
        e.preventDefault();
        loadMainContent('<iframe src="https://docs.google.com/presentation/d/e/2PACX-1vTI6Sc00BSkhS7mHx0pAlzMgXXrGCP5WfB40aMTf_gs5MlIqmQfnAGc905YmUtSYGbFVvmCCOl27jpT/pub?start=false&loop=false&delayms=3000" frameborder="0" width="100%" height="600px" allowfullscreen="true" mozallowfullscreen="true" webkitallowfullscreen="true"></iframe>');
      });
      ...
      document.getElementById('directionalTerms').addEventListener('click', function(e) {
        e.preventDefault();
        loadMainContent('<iframe src="https://docs.google.com/document/d/e/2PACX-1vQbCEkRYLY83Y0P9DZNTP9tpG9_SXteP5UQO8xdoYBkM157N7vPCjkrQ4lYffMT_m2--ErAr8XxvoUd/pub?embedded=true" frameborder="0" width="100%" height="600px"></iframe>');
      });
  
      document.getElementById('chapter3Note').addEventListener('click', function(e) {
        e.preventDefault();
        loadMainContent('<iframe src="https://docs.google.com/document/d/e/2PACX-1vQVskFFSSDjyl5TuZrcct0I1uLJAcMNYhw7GdIQZJL04GT02lVpkJbKFRgDH7Lw0bdYo5-M7BAYIw27/pub?embedded=true" frameborder="0" width="100%" height="600px"></iframe>');
      });
  
      document.getElementById('chapter8Note').addEventListener('click', function(e) {
        e.preventDefault();
        loadMainContent('<iframe src="https://docs.google.com/document/d/e/2PACX-1vRX11qNZkwFbYZD9AGCwgZvy0qigGZjP5PAfiu7fukwOCzmbYJBT5MpFm2tb_fSZ5Bn9FtdnaJEpReS/pub?embedded=true" frameborder="0" width="100%" height="600px"></iframe>');
      });
  
      document.getElementById('chapter7Note').addEventListener('click', function(e) {
        e.preventDefault();
        loadMainContent('<iframe src="https://docs.google.com/document/d/e/2PACX-1vSZ5P3A9FFPaVhCRezVIGvsC7TJVCxcz3rG3iXKXE_KLAWla17ZTqBpJ16KBOxwCejuVWEVOpVs4qJ6/pub?embedded=true" frameborder="0" width="100%" height="600px"></iframe>');
      });
  
      document.getElementById('chapter9Note').addEventListener('click', function(e) {
        e.preventDefault();
        loadMainContent('<iframe src="https://docs.google.com/document/d/e/2PACX-1vSWbu2y22BTQOXuh4gwlTQOecu5MzGCgjJJTf9ivHYllNZmC-BBYZiC1ZGnCUDw_T8BLvc1fX4leuxQ/pub?embedded=true" frameborder="0" width="100%" height="600px"></iframe>');
      });
      ...
      document.getElementById('link3').addEventListener('click', function(e) {
        e.preventDefault();
        loadSidebarContent('<p>Sidebar Content for Link 3</p>');
        loadMainContent('<p>Main Content for Link 3</p>');
      });
